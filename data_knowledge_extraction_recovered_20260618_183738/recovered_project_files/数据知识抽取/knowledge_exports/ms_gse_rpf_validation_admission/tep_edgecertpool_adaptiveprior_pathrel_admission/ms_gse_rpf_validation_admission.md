...
- candidate stability scores: {'baseline': 0.03508771929824561, 'edge_cert_pool': 0.0}
- require candidate certificate: True
- candidate baseline path Jaccard: {'baseline': 1.0, 'edge_cert_pool': 0.07407407407407407}
...
|---|---|---:|---:|---:|---:|---:|---:|---|
| edge_cert_pool | algorithmic | no | -0.0051 | -0.0081 | -0.0760 | 0.0741 | 3 | mean_validation_gain_below_threshold, seed_level_validation_drop, low_tail_class_harm |

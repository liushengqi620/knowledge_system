...
- candidate stability scores: {'baseline': 0.03508771929824561, 'evidcons_rel_s003': 0.03508771929824561, 'salience_cover010': 0.017543859649122806}
- require candidate certificate: True
- candidate baseline path Jaccard: {'baseline': 1.0, 'evidcons_rel_s003': 0.05660377358490566, 'salience_cover010': 0.09615384615384616}
...
|---|---|---:|---:|---:|---:|---:|---:|---|
| evidcons_rel_s003 | other | no | -0.0059 | -0.0097 | -0.0638 | 0.0566 | 3 | mean_validation_gain_below_threshold, seed_level_validation_drop, low_tail_class_harm |

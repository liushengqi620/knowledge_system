...
- candidate stability scores: {'baseline': 0.03508771929824561, 'certcore_coreonly': 0.0, 'certcore_sepcandidate': 0.017543859649122806}
- require candidate certificate: True
- candidate baseline path Jaccard: {'baseline': 1.0, 'certcore_coreonly': 0.03571428571428571, 'certcore_sepcandidate': 0.07547169811320754}
...
|---|---|---:|---:|---:|---:|---:|---:|---|
| certcore_coreonly | other | no | -0.0078 | -0.0173 | -0.1015 | 0.0357 | 3 | mean_validation_gain_below_threshold, seed_level_validation_drop, low_tail_class_harm, baseline_path_overlap_below_threshold |
| certcore_sepcandidate | other | no | -0.0129 | -0.0254 | -0.0974 | 0.0755 | 3 | mean_validation_gain_below_threshold, seed_level_validation_drop, low_tail_class_harm |

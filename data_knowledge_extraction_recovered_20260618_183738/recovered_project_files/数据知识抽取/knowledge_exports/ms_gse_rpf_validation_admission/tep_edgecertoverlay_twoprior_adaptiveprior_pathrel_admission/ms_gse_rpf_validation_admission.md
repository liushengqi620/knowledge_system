...
- candidate stability scores: {'baseline': 0.03508771929824561, 'edge_cert_overlay_twoprior': 0.03508771929824561}
- require candidate certificate: True
- candidate baseline path Jaccard: {'baseline': 1.0, 'edge_cert_overlay_twoprior': 0.21739130434782608}
...
|---|---|---:|---:|---:|---:|---:|---:|---|
| edge_cert_overlay_twoprior | algorithmic | no | -0.0081 | -0.0164 | -0.0862 | 0.2174 | 3 | mean_validation_gain_below_threshold, seed_level_validation_drop, low_tail_class_harm |

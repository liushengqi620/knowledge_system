...
- candidate stability scores: {'baseline': 0.03508771929824561, 'classpath_path_prior_consistency': 0.0, 'agreement_path_prior_consistency': 0.0}
...
|---|---|---:|---:|---:|---:|---:|---|
| agreement_path_prior_consistency | algorithmic | no | -0.0121 | -0.0197 | -0.0789 | 3 | mean_validation_gain_below_threshold, seed_level_validation_drop, low_tail_class_harm |

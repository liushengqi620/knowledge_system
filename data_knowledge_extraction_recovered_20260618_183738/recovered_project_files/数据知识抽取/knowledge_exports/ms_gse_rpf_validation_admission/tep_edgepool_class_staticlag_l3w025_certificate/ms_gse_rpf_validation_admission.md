...
- candidate stability scores: {'baseline': 0.03508771929824561, 'class_staticlag_l3w025': 0.017543859649122806}
...
|---|---|---:|---:|---:|---:|---:|---|
| class_staticlag_l3w025 | algorithmic | no | -0.0086 | -0.0222 | -0.0740 | 3 | mean_validation_gain_below_threshold, seed_level_validation_drop, low_tail_class_harm |

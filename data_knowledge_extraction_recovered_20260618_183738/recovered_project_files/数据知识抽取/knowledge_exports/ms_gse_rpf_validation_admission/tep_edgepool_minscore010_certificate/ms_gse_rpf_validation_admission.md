...
- candidate stability scores: {'baseline': 0.03508771929824561, 'edgepool_minscore010': 0.0}
...
|---|---|---:|---:|---:|---:|---:|---|
| edgepool_minscore010 | algorithmic | no | -0.0148 | -0.0234 | -0.1091 | 3 | mean_validation_gain_below_threshold, seed_level_validation_drop, low_tail_class_harm |

...
- candidate stability scores: {'baseline': 0.03508771929824561, 'edge_fault_family_cert': 0.0}
- require candidate certificate: True
- candidate baseline path Jaccard: {'baseline': 1.0, 'edge_fault_family_cert': 0.1836734693877551}
...
|---|---|---:|---:|---:|---:|---:|---:|---|
| edge_fault_family_cert | algorithmic | no | -0.0075 | -0.0262 | -0.0586 | 0.1837 | 3 | mean_validation_gain_below_threshold, seed_level_validation_drop, low_tail_class_harm |

...
- candidate stability scores: {'baseline': 0.03508771929824561, 'edge_cert_overlay': 0.017543859649122806}
- require candidate certificate: True
- candidate baseline path Jaccard: {'baseline': 1.0, 'edge_cert_overlay': 0.14}
...
|---|---|---:|---:|---:|---:|---:|---:|---|
| edge_cert_overlay | algorithmic | no | -0.0059 | -0.0245 | -0.0717 | 0.1400 | 3 | mean_validation_gain_below_threshold, seed_level_validation_drop, low_tail_class_harm |

...
- candidate stability scores: {'baseline': 0.03508771929824561, 'classcert_f005': 0.017543859649122806, 'classcert_f050': 0.0}
- require candidate certificate: True
- candidate baseline path Jaccard: {'baseline': 1.0, 'classcert_f005': 0.09615384615384616, 'classcert_f050': 0.09433962264150944}
...
|---|---|---:|---:|---:|---:|---:|---:|---|
| classcert_f005 | algorithmic | no | -0.0074 | -0.0121 | -0.0612 | 0.0962 | 3 | mean_validation_gain_below_threshold, seed_level_validation_drop, low_tail_class_harm |
| classcert_f050 | algorithmic | no | -0.0074 | -0.0131 | -0.0943 | 0.0943 | 3 | mean_validation_gain_below_threshold, seed_level_validation_drop, low_tail_class_harm |

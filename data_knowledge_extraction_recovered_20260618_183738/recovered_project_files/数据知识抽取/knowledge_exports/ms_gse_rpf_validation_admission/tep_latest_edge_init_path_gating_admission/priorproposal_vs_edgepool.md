...
- candidate stability scores: {'baseline': 0.03508771929824561, 'priorproposal': 0.05458089668615984}
- require candidate certificate: True
- candidate baseline path Jaccard: {'baseline': 1.0, 'priorproposal': 0.057692307692307696}
...
|---|---|---:|---:|---:|---:|---:|---:|---|
| priorproposal | other | no | 0.0087 | -0.0043 | -0.0679 | 0.0577 | 3 | seed_level_validation_drop, low_tail_class_harm |

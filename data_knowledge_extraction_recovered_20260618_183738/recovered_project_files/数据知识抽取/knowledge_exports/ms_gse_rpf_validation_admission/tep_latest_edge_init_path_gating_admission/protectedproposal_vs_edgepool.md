...
- candidate stability scores: {'baseline': 0.03508771929824561, 'protectedproposal': 0.017543859649122806}
- require candidate certificate: True
- candidate baseline path Jaccard: {'baseline': 1.0, 'protectedproposal': 0.11764705882352941}
...
|---|---|---:|---:|---:|---:|---:|---:|---|
| protectedproposal | other | no | 0.0013 | -0.0150 | -0.0457 | 0.1176 | 3 | seed_level_validation_drop, low_tail_class_harm |

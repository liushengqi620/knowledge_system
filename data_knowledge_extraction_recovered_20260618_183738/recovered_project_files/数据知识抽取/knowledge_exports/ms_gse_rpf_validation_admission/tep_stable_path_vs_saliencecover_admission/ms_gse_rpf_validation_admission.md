...
- candidate stability scores: {'baseline': 0.03508771929824561, 'stable_path_w025_classoff': 0.037037037037037035, 'salience_cover010': 0.017543859649122806}
- require candidate certificate: True
- candidate baseline path Jaccard: {'baseline': 1.0, 'stable_path_w025_classoff': 0.16666666666666666, 'salience_cover010': 0.09615384615384616}
...
|---|---|---:|---:|---:|---:|---:|---:|---|
| salience_cover010 | algorithmic | no | -0.0024 | -0.0045 | -0.0571 | 0.0962 | 3 | mean_validation_gain_below_threshold, seed_level_validation_drop, low_tail_class_harm |
| stable_path_w025_classoff | algorithmic | no | -0.0044 | -0.0136 | -0.0565 | 0.1667 | 3 | mean_validation_gain_below_threshold, seed_level_validation_drop, low_tail_class_harm |

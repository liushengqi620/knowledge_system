...
- candidate stability scores: {'baseline': 0.03508771929824561, 'dual': 0.07212475633528265}
- require candidate certificate: False
- candidate baseline path Jaccard: {'baseline': 1.0, 'dual': 0.0784313725490196}
...
|---|---|---:|---:|---:|---:|---:|---:|---|
| dual | other | no | -0.0169 | -0.0224 | -0.0876 | 0.0784 | 3 | mean_validation_gain_below_threshold, seed_level_validation_drop, low_tail_class_harm |

## Seed Decisions

| Seed | Selected | Val metric | Test Macro-F1 | Test Bal. Acc. | Considered |
|---:|---|---:|---:|---:|---|
| 42 | baseline | 0.7245 | 0.6398 | 0.6526 | baseline=0.7245, dual=0.7096 |
| 43 | baseline | 0.7523 | 0.6396 | 0.6486 | baseline=0.7523, dual=0.7390 |
| 44 | baseline | 0.7412 | 0.6290 | 0.6420 | baseline=0.7412, dual=0.7188 |

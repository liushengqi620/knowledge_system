...
- candidate stability scores: {'baseline': 0.03508771929824561, 'path_prior_consistency': 0.017543859649122806}
...
|---|---|---:|---:|---:|---:|---:|---|
| path_prior_consistency | other | no | 0.0033 | -0.0135 | -0.1009 | 3 | seed_level_validation_drop, low_tail_class_harm |

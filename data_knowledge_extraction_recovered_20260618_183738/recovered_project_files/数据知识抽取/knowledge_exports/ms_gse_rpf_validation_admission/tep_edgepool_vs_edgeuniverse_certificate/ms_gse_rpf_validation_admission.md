...
- candidate stability scores: {'baseline': 0.03508771929824561, 'edge_universe': 0.017543859649122806}
...
|---|---|---:|---:|---:|---:|---:|---|
| edge_universe | algorithmic | no | -0.0008 | -0.0293 | -0.1065 | 3 | mean_validation_gain_below_threshold, seed_level_validation_drop, low_tail_class_harm |

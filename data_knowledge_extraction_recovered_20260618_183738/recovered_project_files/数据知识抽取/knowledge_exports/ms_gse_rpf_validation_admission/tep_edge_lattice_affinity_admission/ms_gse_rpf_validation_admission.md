...
- candidate stability scores: {'baseline': 0.03508771929824561, 'edge_lattice_affinity': 0.037037037037037035}
- require candidate certificate: True
- candidate baseline path Jaccard: {'baseline': 1.0, 'edge_lattice_affinity': 0.14285714285714285}
...
|---|---|---:|---:|---:|---:|---:|---:|---|
| edge_lattice_affinity | algorithmic | no | -0.0078 | -0.0117 | -0.0706 | 0.1429 | 3 | mean_validation_gain_below_threshold, seed_level_validation_drop, low_tail_class_harm |

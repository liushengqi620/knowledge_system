...
- candidate stability scores: {'baseline': 0.03508771929824561, 'edge_candidate_admit': 0.017543859649122806}
- require candidate certificate: True
- candidate baseline path Jaccard: {'baseline': 1.0, 'edge_candidate_admit': 0.14}
...
|---|---|---:|---:|---:|---:|---:|---:|---|
| edge_candidate_admit | algorithmic | no | -0.0047 | -0.0191 | -0.0819 | 0.1400 | 3 | mean_validation_gain_below_threshold, seed_level_validation_drop, low_tail_class_harm |

...
- candidate stability scores: {'baseline': 0.03508771929824561, 'edge_cert_overlay_anchor': 0.017543859649122806}
- require candidate certificate: True
- candidate baseline path Jaccard: {'baseline': 1.0, 'edge_cert_overlay_anchor': 0.2127659574468085}
...
|---|---|---:|---:|---:|---:|---:|---:|---|
| edge_cert_overlay_anchor | algorithmic | no | -0.0029 | -0.0082 | -0.0551 | 0.2128 | 3 | mean_validation_gain_below_threshold, seed_level_validation_drop, low_tail_class_harm |

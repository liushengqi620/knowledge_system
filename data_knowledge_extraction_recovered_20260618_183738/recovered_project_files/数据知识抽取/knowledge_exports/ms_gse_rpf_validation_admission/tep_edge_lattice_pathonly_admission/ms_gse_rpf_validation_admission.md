...
- candidate stability scores: {'baseline': 0.03508771929824561, 'edge_lattice_pathonly': 0.017543859649122806}
- require candidate certificate: True
- candidate baseline path Jaccard: {'baseline': 1.0, 'edge_lattice_pathonly': 0.05555555555555555}
...
|---|---|---:|---:|---:|---:|---:|---:|---|
| edge_lattice_pathonly | algorithmic | no | -0.0081 | -0.0132 | -0.0668 | 0.0556 | 3 | mean_validation_gain_below_threshold, seed_level_validation_drop, low_tail_class_harm |

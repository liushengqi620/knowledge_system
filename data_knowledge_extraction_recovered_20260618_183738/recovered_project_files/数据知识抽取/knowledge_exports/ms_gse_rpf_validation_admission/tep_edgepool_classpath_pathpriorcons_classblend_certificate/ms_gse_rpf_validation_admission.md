...
- candidate stability scores: {'baseline': 0.03508771929824561, 'classblend_path_prior_consistency': 0.05263157894736842}
...
|---|---|---:|---:|---:|---:|---:|---|
| classblend_path_prior_consistency | algorithmic | no | -0.0112 | -0.0162 | -0.0629 | 3 | mean_validation_gain_below_threshold, seed_level_validation_drop, low_tail_class_harm |

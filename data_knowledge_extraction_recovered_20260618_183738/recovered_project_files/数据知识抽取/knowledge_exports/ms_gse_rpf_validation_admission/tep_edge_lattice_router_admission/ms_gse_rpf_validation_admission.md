...
- candidate stability scores: {'baseline': 0.03508771929824561, 'edge_lattice_router': 0.017543859649122806}
- require candidate certificate: True
- candidate baseline path Jaccard: {'baseline': 1.0, 'edge_lattice_router': 0.09615384615384616}
...
|---|---|---:|---:|---:|---:|---:|---:|---|
| edge_lattice_router | algorithmic | no | 0.0023 | -0.0055 | -0.0667 | 0.0962 | 3 | seed_level_validation_drop, low_tail_class_harm |

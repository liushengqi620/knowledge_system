...
- candidate stability scores: {'baseline': 0.03508771929824561, 'proposal_s050': 0.017543859649122806, 'proposal_s035': 0.03508771929824561}
- require candidate certificate: True
- candidate baseline path Jaccard: {'baseline': 1.0, 'proposal_s050': 0.017857142857142856, 'proposal_s035': 0.07692307692307693}
...
|---|---|---:|---:|---:|---:|---:|---:|---|
| proposal_s035 | other | no | -0.0009 | -0.0102 | -0.0609 | 0.0769 | 3 | mean_validation_gain_below_threshold, seed_level_validation_drop, low_tail_class_harm |

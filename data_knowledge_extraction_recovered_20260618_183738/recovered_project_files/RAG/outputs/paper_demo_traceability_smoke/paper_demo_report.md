...
- Balanced demonstration records: 140
...
| balanced_label_masked_text | `label_prior_majority` | 0.1429 | 0.4286 | 0.3704 | 0.0312 | 0.0 | 0.0 | 0.0 |
...
| balanced_label_masked_text | `kg_anchor_reasoning` | 0.4 | 0.8571 | 0.6037 | 0.2885 | 0.0 | 0.0 | 0.0 |
| balanced_label_masked_text | `kg_path_reasoning` | 0.3929 | 0.5714 | 0.5711 | 0.2338 | 0.75 | 0.6643 | 0.6071 |
| balanced_label_masked_text | `proposed_score_fusion` | 1.0 | 1.0 | 1.0 | 0.875 | 0.4643 | 0.4357 | 0.4643 |
| balanced_label_masked_text | `proposed_explainable_rerank` | 1.0 | 1.0 | 1.0 | 0.875 | 0.5071 | 0.4786 | 0.5071 |
| balanced_group_only | `label_prior_majority` | 0.1429 | 0.4286 | 0.3704 | 0.0312 | 0.0 | 0.0 | 0.0 |
| balanced_group_only | `feature_group_prior` | 1.0 | 1.0 | 1.0 | 0.875 | 0.0 | 0.0 | 0.0 |
| balanced_group_only | `feature_name_naive_bayes` | 0.1429 | 0.4286 | 0.3704 | 0.0312 | 0.0 | 0.0 | 0.0 |
| balanced_group_only | `kg_anchor_reasoning` | 0.5857 | 0.8571 | 0.7571 | 0.4487 | 0.0 | 0.0 | 0.0 |
| balanced_group_only | `kg_path_reasoning` | 0.4286 | 0.7143 | 0.6429 | 0.3125 | 0.2857 | 0.2571 | 0.2857 |
| balanced_group_only | `proposed_score_fusion` | 1.0 | 1.0 | 1.0 | 0.875 | 0.1429 | 0.1429 | 0.1429 |
| balanced_group_only | `proposed_explainable_rerank` | 1.0 | 1.0 | 1.0 | 0.875 | 0.1429 | 0.1429 | 0.1429 |
| balanced_feature_anonymized | `label_prior_majority` | 0.1429 | 0.4286 | 0.3704 | 0.0312 | 0.0 | 0.0 | 0.0 |
| balanced_feature_anonymized | `feature_group_prior` | 0.1429 | 0.4286 | 0.3704 | 0.0312 | 0.0 | 0.0 | 0.0 |
| balanced_feature_anonymized | `feature_name_naive_bayes` | 0.1429 | 0.4286 | 0.3704 | 0.0312 | 0.0 | 0.0 | 0.0 |
| balanced_feature_anonymized | `kg_anchor_reasoning` | 0.4286 | 0.8571 | 0.6786 | 0.2917 | 0.0 | 0.0 | 0.0 |
| balanced_feature_anonymized | `kg_path_reasoning` | 0.4286 | 0.8571 | 0.6786 | 0.2917 | 0.0 | 0.0 | 0.0 |
| balanced_feature_anonymized | `proposed_score_fusion` | 0.4286 | 0.5214 | 0.5579 | 0.2917 | 0.0 | 0.0 | 0.0 |
| balanced_feature_anonymized | `proposed_explainable_rerank` | 0.2857 | 0.5714 | 0.4978 | 0.2083 | 0.0 | 0.0 | 0.0 |
